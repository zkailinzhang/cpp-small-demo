...
int main()
{
	...
	GoICP goicp;
	int argc = 6;
	//argv = {"./GOICP ,<MODEL FILENAME>, <DATA FILENAME>, <NUM DOWNSAMPLED DATA POINTS>, <CONFIG FILENAME>, <OUTPUT FILENAME>"};
	char *argv[] = { "./GOICP","model_bunny.txt", "data_bunny.txt","0", "config.txt", "output.txt"};
